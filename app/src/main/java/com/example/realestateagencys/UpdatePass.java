    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String userPassNew = newPass.getText().toString();
                firebaseUser.updatePassword(userPassNew).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            Toast.makeText(UpdatePass.this,"Password Changed",Toast.LENGTH_SHORT).show();
                            finish();
                        }else{    Toast.makeText(UpdatePass.this,"Changing password failed",Toast.LENGTH_SHORT).show();
